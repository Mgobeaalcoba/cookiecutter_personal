"""
Archivo que se corre antes de inicializar mi plantilla de cookiecutter y que verifica que el nombre no contenga x
ademas si los pasos son correctos los msj apareceran en azul. Mientras que si son errores aparecenran en rojo
"""
